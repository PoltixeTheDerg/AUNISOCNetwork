...
progressContainer.panel =
    progressContainer:addChild(GUI.panel(1, 1, progressContainer.width, progressContainer.height, 0xFFFFFF))
progressContainer.itemsContainer =
    progressContainer:addChild(GUI.container(1, 1, progressContainer.width, progressContainer.height))
progressContainer.panel.eventHandler = function()
    update()
end

progressPower =
    progressContainer.itemsContainer:addChild(
    GUI.progressBar(3, 2, 1, color_active, color_passive, color_val, 0, false, true, getLastTickPrefix(), getSuffix())
)
progressStored =
    progressContainer.itemsContainer:addChild(
    GUI.progressBar(
        3,
        progressPower.y + bar_height + 1,
        1,
        color_active,
        color_passive,
        color_val,
...
controlContainer.panel =
    controlContainer:addChild(GUI.panel(1, 1, controlContainer.width + 1, controlContainer.height, 0xF0F0F0))
controlContainer.itemsContainer =
    controlContainer:addChild(GUI.container(1, 1, controlContainer.width + 1, controlContainer.height))

local b_on =
    controlContainer.itemsContainer:addChild(
    GUI.adaptiveRoundedButton(3, 2, 1, 0, 0xFFFFFF, 0x000000, 0x009900, 0xFFFFFF, "On")
)
local b_off =
    controlContainer.itemsContainer:addChild(
    GUI.adaptiveRoundedButton(10, 2, 1, 0, 0xFFFFFF, 0x000000, 0xFF0000, 0xFFFFFF, "Off")
)

local l_min =
    controlContainer.itemsContainer:addChild(GUI.label(4, 4, 10, 1, 0x000000, "Min: " .. stats["rod_min"] .. "%"))
local l_max =
    controlContainer.itemsContainer:addChild(GUI.label(15, 4, 10, 1, 0x000000, "Max: " .. stats["rod_max"] .. "%"))
local b_min_up =
    controlContainer.itemsContainer:addChild(
    GUI.framedButton(3, 5, 10, 3, 0x00ffff, 0x000000, 0x009900, 0x000000, "+10%")
)
local b_min_down =
    controlContainer.itemsContainer:addChild(
    GUI.framedButton(3, 8, 10, 3, 0x00ffff, 0x000000, 0x009900, 0x000000, "-10%")
)
local b_max_up =
    controlContainer.itemsContainer:addChild(
    GUI.framedButton(14, 5, 10, 3, 0xff00ff, 0x000000, 0x009900, 0x000000, "+10%")
)
local b_max_down =
    controlContainer.itemsContainer:addChild(
    GUI.framedButton(14, 8, 10, 3, 0xff00ff, 0x000000, 0x009900, 0x000000, "-10%")
)
